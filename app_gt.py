...
PROJECT_ROOT = r"/mount/src/Agentic-AI-For-Education/"
...
st.set_page_config(page_title="Interactive Tutor (Ground Truth)", page_icon="🤖")

if "session_started" not in st.session_state:
    st.title("🧑‍🎓 Interactive Tutor (Ground Truth)")
