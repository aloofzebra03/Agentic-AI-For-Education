...
Keep it simple and encouraging. Don't lecture - be conversational but at the same time dont give too much text.Keep it minimal. Also ensure that the response is small and not too text heavy.
"""
